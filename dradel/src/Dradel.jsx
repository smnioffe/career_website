...
[1034,"Rob Reiner","M",1947,"United States","New York",true,"1970s",["Film","Acting"],"Actor turned director. Played Michael \"Meathead\" Stivic on All in the Family, then directed This Is Spinal Tap, The Princess Bride, When Harry Met Sally..., and A Few Good Men.",["The son of a legendary comedy writer, he became a director himself","Directed a mockumentary about a band whose amplifiers go to eleven","Played Meathead on All in the Family before directing The Princess Bride"]],
[1044,"Billy Crystal","M",1948,"United States","New York",true,"1980s",["Comedy","Acting"],"Comedian and actor. When Harry Met Sally..., City Slickers, and Monsters, Inc., plus nine turns hosting the Academy Awards.",["Has hosted the Academy Awards nine times","Voiced a one-eyed green monster who coaches a nervous scarer","Told Meg Ryan that men and women can never be friends"]],
[1058,"Bob Saget","M",1956,"United States","Pennsylvania",false,"1990s",["Comedy","Television"],"Comedian and actor. The wholesome father on Full House and host of America's Funniest Home Videos, with a famously filthy stand-up act. Died in 2022.",["Squeaky clean on television, astonishingly filthy on stage","Hosted a show built entirely from viewers' home video mishaps","Played widowed neat freak Danny Tanner on Full House"]],
[1409,"Jake Tapper","M",1969,"United States","New York",true,"2010s",["Journalism","Television"],"CNN anchor and chief Washington correspondent who hosts The Lead and State of the Union.",["A Washington anchor who writes political thrillers on the side","Hosts a weekday cable news show named for the hour's top story","CNN's anchor of The Lead and State of the Union"]],
[1472,"Ari Aster","M",1986,"United States","New York",true,"2010s",["Film","Writing"],"Writer and director of unsettling A24 films: Hereditary, Midsommar, and Beau Is Afraid.",["A24's specialist in making audiences deeply uncomfortable","Set a horror film in the endless daylight of a Swedish summer festival","Directed Hereditary and Midsommar"]],
[1481,"Jenny Slate","F",1982,"United States","Massachusetts",true,"2010s",["Comedy","Acting"],"Comedian and actor. Saturday Night Live, Obvious Child, Parks and Recreation, and the voice of Marcel the Shell.",["Lasted a single season as a Saturday Night Live cast member","Voiced a tiny talking shell who wears shoes","Played Mona-Lisa Saperstein on Parks and Recreation and starred in Obvious Child"]],
[1511,"Dave Portnoy","M",1977,"United States","Massachusetts",true,"2010s",["Business","Journalism"],"Founder of Barstool Sports, known for his one-bite pizza reviews and a combative online persona.",["Started out handing a free sports paper to commuters in Boston","Reviews pizza one slice at a time and always saves a bite for later","Founded Barstool Sports and calls himself El Presidente"]],
];
